...
class MapSettingsDialog(QDialog):
    ...
    def __init__(self, api, map_id, db_connections, plan):
        ...
        # set connections
        self.ui.viewer_active_chkb.stateChanged.connect(
            self.enable_user_management)
    ...
    def enable_user_management(self):
        if not self.ui.viewer_active_chkb.isChecked():
            self.ui.users_lineedit.setEnabled(False)
            self.ui.add_users_btn.setEnabled(False)
            self.ui.delete_user_btn.setEnabled(False)
            self.ui.show_userlist_btn.setEnabled(False)
        elif self.ui.wms_public_chkb.isChecked() and self.ui.map_public_chkb.isChecked():
            self.ui.users_lineedit.setEnabled(False)
            self.ui.add_users_btn.setEnabled(False)
            self.ui.delete_user_btn.setEnabled(False)
            self.ui.show_userlist_btn.setEnabled(False)
            ...
            self.ui.show_userlist_btn.setEnabled(True)
    ...
    def add_user(self):
        ...
        if self.ui.users_lineedit.text() and self.ui.users_lineedit.text().isspace() is False:
            if nonexistent_users:
                ...
                self.ui.users_lineedit.setText(", ".join(nonexistent_users))
            else:
                QGuiApplication.restoreOverrideCursor()
    ...
    def save_options(self):
        ...
        if self.ui.search_sql_textedit.isEnabled():
